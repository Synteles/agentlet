...
- Strengthened PR checks: added 85% coverage threshold, arm64 Docker build validation, and Trivy SARIF upload to the GitHub Security tab; removed redundant summary job in favour of direct branch protection rules; arm64 build now runs on merge only to reduce PR feedback time.
